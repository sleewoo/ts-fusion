...
export type UtilityPatternsTest1<T> = [T, Error | null];

export type UtilityPatternsTest2 = [init: () => void, dispose: () => void];
...
export type UtilityPatternsTest4<T> = [current: T, previous: T];

export type UtilityPatternsTest5 = [id: string, ...dependencies: never[]];

export type UtilityPatternsTest6 = [timestamp: Date, ...data: unknown[]];

export type UtilityPatternsTest7 = [string, ...(number | boolean)[]];

export type UtilityPatternsTest8 = [readonly string[], mutable: number[]];

export type UtilityPatternsTest9<T> = [Promise<T>, AbortController];
...
export type UtilityPatternsTest12<T> = [key: keyof T, defaultValue: T[keyof T]];

export type UtilityPatternsTest13<T> = [T, ...Partial<T>[]];
...
export type UtilityPatternsTest15<T> = [T, ...(keyof T)[]];
